...
% Input u = Mux vector: Thrust [rho,A,v,v_tip,k1,k2], Lift/Drag [rho,v,S,C_L or C_D], PID [e,e_int,e_der,Kp,Ki,Kd]
code_thrust = [
'function T = thrust_block(u)' newline ...
'rho = u(1); A = u(2); v = u(3); v_tip = u(4); k1 = u(5); k2 = u(6);' newline ...
'if v_tip <= 0' newline ...
'    C_T = 0;' newline ...
'else' newline ...
'    ratio = v / v_tip;' newline ...
'    C_T = k1 * ratio + k2 * ratio^2;' newline ...
'end' newline ...
'T = 0.5 * rho * A * v^2 * C_T;' newline ...
'end'
];
